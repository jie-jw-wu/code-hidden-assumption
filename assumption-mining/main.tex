...
\midrule
Total ground-truth assumptions          & \todonumber{X} (pilot: 111) \\
Mean assumptions per task               & \todonumber{X} (pilot: 3.7) \\
Median assumptions per task             & \todonumber{X} (pilot: 4.0) \\
\midrule
T1 Input Validation                     & \todonumber{X} (pilot: 19, 17.1\%) \\
T2 Data Format                          & \todonumber{X} (pilot: 30, 27.0\%) \\
T3 Error Policy                         & \todonumber{X} (pilot: 24, 21.6\%) \\
T4 Persistence                          & \todonumber{X} (pilot: 9, 8.1\%) \\
T5 Performance                          & \todonumber{X} (pilot: 24, 21.6\%) \\
T6 Security                             & \todonumber{X} (pilot: 5, 4.5\%) \\
\midrule
Mean lines of code per task             & \todonumber{X} (pilot: 10.5) \\
Inter-annotator agreement ($\kappa$)    & \todonumber{X} (pilot: N/A) \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
T1 Input Validation & \todonumber{} & \todonumber{} & \todonumber{} & \todonumber{} & \todonumber{} \\
...
T6 Security         & \todonumber{} & \todonumber{} & \todonumber{} & \todonumber{} & \todonumber{} \\
\midrule
...
\midrule
Keyword Heuristic (KH)  & 0.532 & 0.501 & T6 (—) & T3 (—) \\
Full-File (FF)          & 0.072 & 0.188 & — & — \\
\sysname (heuristic)   & \textbf{0.568} & \textbf{0.554} & T6 (0.80) & T3 (—) \\
...
T6 (Security) achieves the highest accuracy (0.80); T3 (Error Policy) is
hardest as error handling can manifest at any control-flow site.
...
The \todonumber{X} novel tasks in \benchname are designed to be out-of-distribution
