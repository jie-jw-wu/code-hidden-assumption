...
The improvement stems from expanded AST node coverage: T3 assumptions are
found at \texttt{with\_statement} and \texttt{call} sites; T5 assumptions are
linked to performance-library imports.
\end{rqbox}
